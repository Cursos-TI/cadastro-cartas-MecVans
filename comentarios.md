// A princípio, a minha ideia já não era duplicar variáveis, mas sim utilizar FOR para criar as condições.
// Como no segundo desafio ficou claro que eu deveria seguir sem esse tipo de "operador", eu dupliquei as variáveis e fui no "simples".
